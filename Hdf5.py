...
cleaned_data = pd.read_csv('data/prepared/vak_datak8.csv', header=None)
...
with pd.HDFStore('data/prepared/val_data.hdf5', mode='w') as store:
   store.put('data',ndf)

print("Данные:")
print(pd.read_hdf("data/prepared/val_data.hdf5", 'data'))